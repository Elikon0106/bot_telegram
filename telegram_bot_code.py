...
API_TOKEN = 'OYUR_API_TOKEN'  # Замените на ваш токен
OPENAI_API_KEY = 'YOUR_OPNEAI_API_KEY'  # Замените на ваш OpenAI API ключ
...
courses = [
    ...
    },
    {
        ...
        "video_link": "https://www.youtube.com/watch?v=vQenhmGQ9yw&list=PLftd3YpHHMTON0Xpnx7iUofNexDuIfCfG",
        "assignment_link": "https://forms.gle/9DMYDS8HWf5QR6YQA"
    },
    {
